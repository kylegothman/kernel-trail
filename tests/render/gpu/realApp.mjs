...
export async function runRealApp(browser, baseUrl, webgpuAvailable) {
  ...
  await page.evaluate(async count => {
            ...
            try {
              await Promise.race([
                ...
                new Promise((_, reject) => { timer = setTimeout(() => reject(new Error('Real app frames or GPU completion stalled')), 60_000); }),
              ]);
