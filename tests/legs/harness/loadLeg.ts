...
export interface LoadOptions {
  ...
  readonly loader?: () => Promise<{ default: Leg }>;
}
 ...
 * index that imports a forbidden layer, rejects on import, or exports the
 * wrong shape throws with the id in the message.
 */
